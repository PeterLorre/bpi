...
- moving bpi ahoy function to main functions file
...
- removed "Powered by Wordpress & bpi" from footer, because let's face it: we all delete this anyway.
...
- removed default "bpi" text in footer if you don't have a menu
...
- added bpi body class depending on what browser
...
- added post formats to bpi.php core
...
- fixed error in bpi.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the bpi file so it's easier to see what's being
	called.
